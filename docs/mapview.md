...
| `mapType` | `String` | `"standard"` | The map type to be displayed. <br/><br/> - standard: standard road map (default)<br/> - satellite: satellite view<br/> - hybrid: satellite view with roads and points of interest overlayed<br/> - terrain: terrain view<br/> - custom: custom tiles
| `tilesSource` | `String` |  | URL as string for path to tiles e.g. http://tile.openstreetmap.org/{z}/{x}/{y}.png Only used if `mapType` is of type `custom`.
